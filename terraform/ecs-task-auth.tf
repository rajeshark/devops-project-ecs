  ...
  container_definitions = jsonencode([
    {
      ...
      secrets = [
        {
          name      = "JWT_SECRET"
          valueFrom = "arn:aws:secretsmanager:ap-south-1:775826428475:secret:/quickcart/backend/common-rL3fc5"
        },
        {
          name      = "DB_PORT"
          valueFrom = "arn:aws:secretsmanager:ap-south-1:775826428475:secret:/quickcart/backend/common-rL3fc5"
        ...
        {
          name      = "DB_HOST"
          valueFrom = aws_ssm_parameter.db_host.arn   # dynamic value from RDS endpoint
        },
        {
          name      = "NODE_ENV"
          valueFrom = "arn:aws:secretsmanager:ap-south-1:775826428475:secret:/quickcart/backend/common-rL3fc5"
